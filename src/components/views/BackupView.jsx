...
const styles = {
  ...
  sidebar: { height: "100vh", position: "sticky", top: 0, background: "#fffdf8", borderRight: "1px solid #f0e5d8", padding: "28px 20px", display: "flex", flexDirection: "column" },
  ...
  navItem: { border: "none", background: "transparent", color: "#5c5047", padding: "12px 16px", borderRadius: "12px", textAlign: "left", fontWeight: "700", cursor: "pointer", transition: "all 0.2s" },
  navItemActive: { background: "#fff1df", color: "#e85d04" },
  logoutButton: { marginTop: "auto", border: "none", background: "#e85d04", color: "white", borderRadius: "12px", padding: "14px", fontWeight: "800", cursor: "pointer" },
